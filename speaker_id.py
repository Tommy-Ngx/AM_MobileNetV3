...
from mobilenet1d import MobileNetV3
...
# ----- MobileNet -----
MOBILENET_net = MobileNetV3(num_classes=class_lay)
MOBILENET_net.cuda()
# ----- MobileNet -----

if pt_file!='none':
    print('Start Loading old Epoch process...')
    checkpoint_load = torch.load(pt_file)
    print ('Checking...checkpoint and start loading ...')
    MOBILENET_net.load_state_dict(checkpoint_load['MOBILENET_model_par'])
    print ('Loading successfully.^_^')
